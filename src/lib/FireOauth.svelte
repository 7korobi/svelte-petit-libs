...
{#if user}
<span class="tap pull-right"><i class="btn mdi mdi-logout" on:click={signOut}></i></span>
<span class="tap"><i class={icon}> &thinsp; { user.displayName }</i></span>
{:else}
<span class="tap"><i class="btn mdi mdi-facebook-box" on:click={facebook}></i></span>
<span class="tap"><i class="btn mdi mdi-twitter" on:click={twitter}></i></span>
<span class="tap"><i class="btn mdi mdi-windows" on:click={microsoft}></i></span>
<span class="tap"><i class="btn mdi mdi-google" on:click={google}></i></span>
<span class="tap"><i class="btn mdi mdi-github-face" on:click={github}></i></span>
{/if}
